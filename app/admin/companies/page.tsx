                    ...
                    <form onSubmit={handleCreate} className="space-y-4">
                        ...
                        <div className="flex gap-3">
                            <button
                                type="submit"
                                disabled={saving}
                                className="bg-gold hover:bg-gold-light disabled:opacity-50 text-dark font-body font-semibold px-6 py-2.5 rounded-xl text-sm transition-colors"
                            >
                            ...
                            <button
                                ...
                                className="px-6 py-2.5 rounded-xl border border-surface-3 text-muted hover:text-white-soft text-sm font-stats transition-colors"
                            >
                                Cancel
                            </button>
                        </div>
                    ...
                    {companies.map(c => (
                        <div key={c.id} className="bg-surface border border-surface-3 rounded-2xl p-5 flex items-center justify-between gap-4">
                            ...
                            <Link
                                ...
                                className="shrink-0 text-xs font-stats px-4 py-2 rounded-xl border border-surface-3 text-muted hover:text-white-soft hover:border-gold/30 transition-all"
                            >
                                Manage →
                            </Link>
                        </div>
